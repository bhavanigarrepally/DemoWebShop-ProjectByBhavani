...
public class ProductTest extends BasicConfig {
	...
	public void Book_HealthBookTest() {
		...
		// Verify SearchBox in Welcome page is displayed and enabled, and then enter
		// text
		...
		// Verify Healthbook - Add to cart button is displayed and enabled, then click
		...
		// Verify Shopping cart is displayed and enabled, then click on Shopping cart
		// link
		...
		waitStatement(wpobj.getshoppingCart());

		clickElement_usingJsCode(wpobj.getshoppingCart());
		...
		// Click on Ship Address Continue Button
		...
		// Click On Ship Method Continue Button
		...
		// Click On Pay Method Continue Button
		...
		// Click on Pay Info Continue Button
		...
		//clickOnElement(copobj.getconfirmOrderSuccess());
		//Reporter.log("Order confirm success",true);
	...
	public void Computers_desktopTest() {
		...
		Reporter.log("Clicked on Computer Header", true);

		// Verify Desktop header displayed and enabled in computer tab, then Hover on
		// header
		...
		Reporter.log("Clicked on Desktop Header", true);

		// Verify Desktop - Add to cart button is displayed and enabled, then click on
		// Add to Cart button
		...
		Reporter.log("Desktop added to cart", true);
		...
		// click on Bill Address continue button
		waitStatement(copobj.getbillAddressContinue());
	...
	public void Computers_notebooksTest() {
		...
		// Verify Notebooks header displayed and enabled in computer tab, then Hover on
		// header
		...
		Reporter.log("clicked on notebooks header", true);

		// Verify Notebook - Add to cart button is displayed and enabled, then click on
		// Add to Cart button
		...
		Reporter.log("NoteBook added to cart", true);
	...
	public void Computers_accessoriesTest() {
		...
		// Verify Accessories header displayed and enabled in computer tab, then Hover
		// on header
		...
		Reporter.log("Clicked on Accessories Header", true);

		// Verify Accessories - Add to cart button is displayed and enabled, then click
		// on Add to Cart button
		...
		Reporter.log("Accessories added to cart", true);
	...
	@Test(enabled = false, priority = 6, groups = "FT")
	...
	public void Electronics_cellphonesTest() {
		...
		Reporter.log("Clicked on Electronics Header", true);

		// Verify CellPhone header displayed and enabled in Electronics tab, and then
		// Hover on header
		...
		Reporter.log("Clicked on Cellphone Header", true);
		...
		Reporter.log("Cellphone added to cart", true);
